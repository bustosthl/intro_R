...
https://rpubs.com/andresjimenez_p/fundamental_r rstudio ide
...
tidyverse: 
read_csv, read_xlsx, 
summary, unique, table, glimpse, info, dim, class, names, sample_n, head
select, filter, mutate, case_when, starts_with, contains, %>%, rename, group_by, summarise, pivot_longer, pivot_wider, left_join, bind_rows, 
if, loop, funciones, 
Errores! stackoverflow, chatgpt
